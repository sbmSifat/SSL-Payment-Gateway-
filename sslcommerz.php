...
<head>
    ...
    <title>SSLCommerz Payment Created By Sifat</title>
...
<div class="container">
    <div class="py-5 text-center">
        <h2>SSLCommerz Payment Created By Sifat</h2>

        <p class="lead">GiveHope Payment with SSLCommerz.</p>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Including VAT</h6>
            ...
            <form method="POST" class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="customer_name" class="form-control" id="customer_name" placeholder="Md. Sifat Bin Mahbub"
                               value="" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="Example: 7/B, Rankin Street, Wari, Dhaka">
                    <div class="invalid-feedback">
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2022 @GiveHope By Sifat</p>
